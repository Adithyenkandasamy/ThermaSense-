...
from app.services.ingest_service import get_stats, run_ingestion
...
@ingest_router.post("/ingest", response_model=IngestResponse, summary="Trigger FIRMS ingestion")
async def trigger_ingest(
    db: AsyncSession = Depends(get_db),
) -> IngestResponse:
    """
    Manually trigger a NASA FIRMS data fetch and ingestion cycle.

    This is automatically called every 10 minutes by the background scheduler,
    but you can also call it manually to get fresh data immediately.
    """
